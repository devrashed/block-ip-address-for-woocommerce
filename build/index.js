...
function App() {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("h1", {
      children: " Add Block IP "
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(react_hot_toast__WEBPACK_IMPORTED_MODULE_1__.Toaster, {
      position: "top-center"
    })]
  });
}
...
/* harmony import */ var react_hot_toast__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-hot-toast */ "./node_modules/react-hot-toast/dist/index.mjs");
/* harmony import */ var _NewIp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./NewIp */ "./src/components/NewIp.js");
/* harmony import */ var _ViewIblocklist__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ViewIblocklist */ "./src/components/ViewIblocklist.js");
...
const IpManager = () => {
  const [blockedIps, setBlockedIps] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [loading, setLoading] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
  const fetchBlockedIps = () => {
    axios__WEBPACK_IMPORTED_MODULE_5__["default"].get(`${blocipadwoo.apiUrl}/wprk/v1/get_blkip`, {
      headers: {
        'Content-Type': 'application/json',
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_NewIp__WEBPACK_IMPORTED_MODULE_2__["default"], {
      onIpAdded: fetchBlockedIps
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_ViewIblocklist__WEBPACK_IMPORTED_MODULE_3__["default"], {
      blockedIps: blockedIps,
      loading: loading,
      refresh: fetchBlockedIps
    })]
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IpManager);

/***/ }),

/***/ "./src/components/NewIp.js":
/*!*********************************!*\
  !*** ./src/components/NewIp.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const NewIp = ({
  ...
  const [ipaddress, setIpaddress] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [redirect, setRedirect] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  ...
  const [editBlockType, setBlockType] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [editBlockCategory, setBlockCategory] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [selectedCategory, setSelectedCategory] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [pageOption, setPageOption] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    axios__WEBPACK_IMPORTED_MODULE_3__["default"].get(`${blocipadwoo.apiUrl}/wp/v2/product_cat`).then(res => {
  ...
  const handleSubmit = e => {
    ...
    if (!ipRegex.test(ipaddress)) {
      react_hot_toast__WEBPACK_IMPORTED_MODULE_1__["default"].error('Invalid IP address! Please enter a valid IP.', {
        position: 'top-center',
        duration: 4000,
        style: {
          color: '#D32F2F',
    ...
    if (end <= start) {
      react_hot_toast__WEBPACK_IMPORTED_MODULE_1__["default"].error('End Date must be later than Start Date', {
        position: 'top-center',
        duration: 4000,
        style: {
          color: '#D32F2F',
    ...
    axios__WEBPACK_IMPORTED_MODULE_3__["default"].post(`${blocipadwoo.apiUrl}/wooip/v1/new_ip`, {
      ipaddress,
      blocktype,
      blkcategory,
      redirect,
      ...
      if (response?.status === 'success') {
        react_hot_toast__WEBPACK_IMPORTED_MODULE_1__["default"].success(response.message, {
          position: 'top-center',
          duration: 4000,
          style: {
            color: '#2e7d32',
        ...
        react_hot_toast__WEBPACK_IMPORTED_MODULE_1__["default"].error(response.message, {
          position: 'top-center',
          duration: 4000,
          style: {
            color: '#D32F2F',
      ...
      react_hot_toast__WEBPACK_IMPORTED_MODULE_1__["default"].error('Something went wrong. Please try again.', {
        position: 'top-center',
        duration: 4000,
        style: {
          background: '#fff3cd',
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("form", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
      ...
      }), pageOption === 'category' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
        className: "form-group",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("label", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (NewIp);
...
const ViewIblocklist = ({
  blockedIps = [],
  refresh
}) => {
  const [editingIndex, setEditingIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  const [editIp, setEditIp] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [editRedirect, setRedirect] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [editstartDate, setStartdate] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [editendDate, setEnddate] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [editBlockType, setBlockType] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [editBlockCategory, setBlockCategory] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const handleDelete = id => {
    if (window.confirm("Are you sure you want to delete this blocked IP?")) {
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post(`${blocipadwoo.apiUrl}/wprk/v1/delete_blkip`, {
        id
      }, {
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleUpdate = ip => {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2__["default"].post(`${blocipadwoo.apiUrl}/wprk/v1/update_blkip`, {
      id: ip.id,
      ipaddress: editIp,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("thead", {
        ...
        children: blockedIps.length > 0 ? blockedIps.map((ip, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("tr", {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("td", {
            children: editingIndex === index ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("input", {
              type: "text",
              value: editIp,
            ...
            children: [editingIndex === index ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button", {
              className: "btn btn-edit",
              onClick: () => handleUpdate(ip),
              children: "Update"
            }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button", {
              className: "btn btn-edit",
              onClick: () => handleEdit(index, ip),
              children: "Edit"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button", {
        ...
        }, ip.id)) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("tr", {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("td", {
            colSpan: "5",
            children: "No blocked IPs found."
          })
        })
      })]
    })]
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ViewIblocklist);
...
/* harmony import */ var _components_NewIp__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/NewIp */ "./src/components/NewIp.js");
/* harmony import */ var _components_ViewIblocklist__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/ViewIblocklist */ "./src/components/ViewIblocklist.js");
/* harmony import */ var _components_IpManager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/IpManager */ "./src/components/IpManager.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  ReactDOM.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_App__WEBPACK_IMPORTED_MODULE_2__["default"], {}), element);
});
let newip = document.getElementById('new-ipaddress');
if (newip) {
  ReactDOM.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_IpManager__WEBPACK_IMPORTED_MODULE_5__["default"], {}), newip);
}
let viewip = document.getElementById('view-iplist');
if (viewip) {
  ReactDOM.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_ViewIblocklist__WEBPACK_IMPORTED_MODULE_4__["default"], {}), viewip);
}
})();
